...
if (isset($_GET['ajax']) && $_GET['ajax'] === 'get_schools') {
    ...
    $sqlAjax = "SELECT s.Name, s.Latitude, s.Longitude 
            FROM school s
                ...
                .then(data => {
                    ...
                    if (data.status === 'success' && data.data.length > 0) {
                        ...
                        data.data.forEach(school => {
                            ...
                            // คลิกที่หมุดแล้วแสดงชื่อบน Popup
                            marker.addListener("click", () => {
                                infoWindow.setContent(`<div class="p-3 pt-2 font-kanit min-w-[150px]"><strong class="text-blue-600 font-medium text-lg">${school.name}</strong></div>`);
